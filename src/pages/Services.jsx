...
const Services = () => {
    return(
        <main>
            <div class="mb-3"></div>
            <h2 class="text-center">Mon offre de services</h2>
            <p class="text-center">Voici les prestations sur lesquelles je peux intervenir</p>
            <hr class="border border-primary w-25 mx-auto"/>
            <section class="row col-lg-8 col-sm-12 mx-auto my-4">
