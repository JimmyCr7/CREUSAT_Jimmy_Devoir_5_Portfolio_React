    ...
    return(
        <main class="my-4 flex-column">
            <section>
                ...
                <div class="d-flex flex-wrap col-lg-8 col-sm-12 justify-content-center mt-3 mx-auto shadow-lg p-3">
                    <article class="container-fluid col-lg-6 mb-4">
                    ...
                    <article id="container-coordonnees" class="container-fluid col-lg-6">
